...
form[0].addEventListener('submit', function (e) {
    ...
    let formData = {
        ...
        sold: false,
        addedBy: username,
        addedOn: (now.getDate() + ' - ' + (now.getMonth() + 1) + ' - ' + now.getFullYear() + ' ' + now.getHours() + ' - ' + now.getMinutes() + ' - ' + now.getSeconds())
    }
...
form[1].addEventListener('submit', function (e) {
    ...
    if (confirm('This will delete all of your books whose name contains ' + data.value + ' in it. Are you sure that you want to delete all of those books?')) {
        ...
        xhr.onload = function () {
            ...
            if (xhr.responseText == 'deleted') {
                ...
                deletionMsg.innerText = "This book does not exists in our database, please check the spellings of your book name and try again...";
